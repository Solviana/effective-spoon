...
{
    f_q_pst->tail_u32 += 1;
    if (f_q_pst->tail_u32 >= f_q_pst->size_u32)
    {
...
void game_polyqueue_realloc(type_polyqueue_st* f_q_pst) 
{
    ...
    f_q_pst->polygonbuffer_ppst = (type_polyline_st**)realloc(f_q_pst->polygonbuffer_ppst, f_q_pst->size_u32 * sizeof(type_polyline_st*));
}
